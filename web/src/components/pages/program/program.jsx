        ...
        <section className="question">
          ...
          <div className="panel_program">
            <p>
              ...
              Varghese, the artistic director of Soorya Dance School. <br />
              ...
              support of their parents. <br />I would like to invite the parents
              of the dancers to the stage ... <br />
          ...
          <div className="panel_program">
            <p>
              ...
              would like to invite .... onto the stage to say a few words. Let
              us watch Jana's solo performance. <br />
              [Jasmine] ‘Esther’ is a Padam based on the biblical story of
              Esther, the beautiful Jewish queen. The dancer describes the story
              where Esther asks the king to a dinner party. The king was happy
              and granted her a wish, Esther reveals her true purpose and
              explains Haman's wicked plan to destroy her and her people. The
              King ordered to execute Haman on the gallows he built for
          ...
          <div className="panel_program">
            <p>
              [Megha] Next will be a solo presentation by Michelle Eapen. First,
              I would like to invite .... onto the stage to say a few words. Let
              us watch Michelle's solo performance. <br />
              [Jasmine] - ‘Durge Durge Jaya Jaya Durge’ appears to be a
              devotional phrase in Sanskrit dedicated to the goddess Durga, a
              Hindu deity symbolizing strength and protection. The words “Durge
              Durge” invoke the name of Durga twice, emphasizing her power.
              “Jaya Jaya” translates to “victory, victory,” praising her
              triumph. This phrase is commonly chanted during festivals like
              Navaratri, where Durga is celebrated for her victory over evil.
              The repetition of her name and the phrase’s meaning emphasize
              devotion and reverence. Orchestra plays Ragam
            </p>
            <p>
              Ragam: Revathi <br />
              Talam: Adi <br />
