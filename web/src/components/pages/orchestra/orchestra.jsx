      ...
      <div>
        ...
        <section className="questions">
          ...
          <div className="panel">
            <p className="accordion-text">
              ...
              started learning music at the age of 5 under Guru Janardhanan
              Potty. He has performed in many countries with leading
              Bharatanatyam artists as well as Kalakshetra artists. His
              strongest role is as a vocalist, and in this capacity, he has
              toured all over the world. He has been teaching Carnatic music to
              many students in India. He has won the Central Government Of India
              Scholarship for Classical Vocal from 2000 to 2002. He is also a
              recipient of the Vijayalakshmi Endowment award for the best
          ...
          <div className="panel">
            <p className="accordion-text">
              ...
              HCL Best Concert Award from the Music Academy. He also won the
              CCRT Scholarship for Junior Artists from the Ministry of Culture.{" "}
              <br />
          ...
          <div className="panel">
            <p className="accordion-text">
              ...
              a few. He has also been performing for the past 20 years. <br />
          ...
          <div className="panel">
            <p className="accordion-text">
              ...
              regularly in India and abroad. <br />
        ...
        <div className="musician_container">
          ...
          <p className="accordion-text">
            <strong>
              {" "}
              The history of Indian dance is a rich tapestry woven with
              spiritual, cultural, and artistic traditions that span thousands
              of years. Its roots trace back to pre-Vedic times and are
              formalized in the Natya Shastra, an ancient Sanskrit treatise
              attributed to Bharata Muni, which laid the foundation for Indian
              classical dance and drama by defining essential elements like
              nritta (pure dance), nritya (expressive dance), and natya
              ...
              through movement. Over time, distinct classical dance styles
              emerged across India, each reflecting regional culture, language,
              and devotion. <br />
              <br />
              There are eight officially recognized classical forms:
              Bharatanatyam (Tamil Nadu), Kathak (North India), Kathakali and
              Mohiniyattam (Kerala), Kuchipudi (Andhra Pradesh), Odissi
              (Odisha), Manipuri (Manipur), and Sattriya (Assam). Each style
              combines intricate gestures, facial expressions, rhythm, and
              costume to convey stories—often rooted in mythology and devotion.{" "}
              <br />
              <br />
              Alongside these classical styles, India’s folk and tribal dances
              add vibrant color and diversity, often performed during festivals,
              harvests, and community events. Dances like Bhangra and Giddha
              from Punjab, Garba and Dandiya from Gujarat, Lavani from
              Maharashtra, Ghoomar from Rajasthan, and Chhau from Eastern India
              reflect the everyday life, spirit, and joy of the people. <br />
              <br />
              ...
              Contemporary Indian dancers often blend ballet, hip hop, and
              modern dance with traditional forms, creating new expressions of
              cultural identity. Today, Indian dance thrives not only on stage
              and screen but also in global classrooms and festivals, showcasing
              the country's profound artistic heritage. From sacred temple
              rituals to international performances, Indian dance continues to
              be a dynamic and powerful form of storytelling and expression.
            </strong>
          </p>
        </div>
        <Navigation />
